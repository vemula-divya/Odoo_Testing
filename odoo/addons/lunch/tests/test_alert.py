...
class TestAlarm(TestsCommon):
    ...
    def test_cron_sync_create(self):
        ...
        logging.info(self.alert_ny.cron_id)
        logging.info(cron_ny.active)
        logging.info(cron_ny.name)
        logging.info(cron_ny.nextcall)
        ...
        logging.info("tokyo_cron.nextcall" + tokyo_cron.nextcall)
        logging.info("Test case 'lunch'-2")
    ...
    def test_cron_sync_active(self):
        ...
        self.assertTrue(cron_ny.active)
        logging.info("Test case 'lunch'-1")
    ...
    def test_cron_sync_nextcall(self):
        ...
        logging.info("Test case 'lunch' completed")
